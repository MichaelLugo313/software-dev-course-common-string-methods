...
let learningString = "Learning JavaScript is fun!";

//Activity 1

let includesJavascript = learningString.includes("JavaScript");

let funPosition = learningString.indexOf("fun");

//Activity 2

let cleanedString = " CODE BOOTCAMP ".trim().toLowerCase();

let replacingString = cleanedString.replace("bootcamp", "JavaScript");

//Activity 3

let brokenApart = "Coding is fun and educational".split(" ");

//Activity 4

let firstChar = "Bootcamp".charAt(0);
let extractedCamp = "Bootcamp".slice(4,8);
